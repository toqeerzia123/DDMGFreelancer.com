...
export class AdminComponent implements OnInit {
  ...
  constructor(public menuItems: MenuItems,public changeprofiledto:ChangeProfileDto, public authService: AuthService, private alertify: AlertifyService, private router: Router) {
    this.navType = 'st5';
